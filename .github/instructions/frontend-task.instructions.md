---
applyTo: "docs/frontend-tasks/**/*.md"
---

For frontend tasks, use the standard task structure and SRS-grounded planning. If CRs or clarification answers arrive, run input sync before implementation.
